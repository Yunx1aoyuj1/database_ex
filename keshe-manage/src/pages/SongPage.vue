<template>
  <div class="table">
    ...
    <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
      <el-form action="" :v-model="registerForm"  ref="registerForm" label-width="80px" id="tf">
        <div>
          <label>歌曲名</label>
        ...
        <div>
          <label>专辑</label>
          <el-input type="text" value="" name="introduction" v-model="registerForm.introduction"></el-input>
        </div>
        <div>
          <label>歌词</label>
          <el-input type="textarea" value="" name="lyric" v-model="registerForm.lyric"></el-input>
        </div>
        <div>
          <label>歌曲上传</label>
          <br>
...
export default {
  ...
  methods: {
    ...
    addSong () {
      ...
      form.set('introduction', this.registerForm.introduction)
      if (!form.get('lyric')) {
