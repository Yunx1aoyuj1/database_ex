package com.liaojunxuan.controller;

import com.alibaba.fastjson.JSONObject;
import com.liaojunxuan.domain.Consumer;
import com.liaojunxuan.service.impl.ConsumerServiceImpl;
...
//        System.out.println(username+"  "+password+"  "+sex+"   "+phone_num+"     "+email+"      "+birth+"       "+introduction+"      "+location);
    ...
    public Object updateUserPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        System.out.print(avatorFile.getOriginalFilename().toString());
